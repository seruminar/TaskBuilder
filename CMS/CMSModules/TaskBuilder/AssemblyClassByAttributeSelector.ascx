<%@ Control Language="C#" AutoEventWireup="true"  CodeFile="~/CMSModules/TaskBuilder/AssemblyClassByAttributeSelector.ascx.cs" Inherits="CMSModules_TaskBuilder_AssemblyClassByAttributeSelector" %>
